import argparse, signal, time, numpy as np
import MCloud, MCloudPacketRCV #type: ignore



parser = argparse.ArgumentParser("Create asr dummy with arbitrary fingerprint")
parser.add_argument('lang', help="The language to mimick")
args = parser.parse_args()

print(f"Worker for {args.lang}")
...
IN_FINGERPRINT = args.lang.encode('utf-8')
IN_TYPE = 'audio'.encode('utf-8')
OUT_FINGERPRINT = args.lang.encode('utf-8')
...
def data_callback(i, sampleA):
    ...
    text = [IN_FINGERPRINT.decode('utf-8')]
    global count
